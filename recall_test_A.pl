...
print "PART NAME IS == $partNo REV == $rev sequence is = $seq  \n" ;
               ...
               <soapenv:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:urn="urn:get_recall_attributes">
                    <soapenv:Header/>
                        <soapenv:Body>
                            ...
                            <Item xsi:type="xsd:string">$partNo</Item>
...
if ($response->is_success) {
    ...
    #writing file in txt file in result dir
    open my $fh, '>', "$resultDir\\attribute.txt" or die "Could not open file: $!";
...
my $InputtxtFile = "$resultDir\\attribute.txt";
